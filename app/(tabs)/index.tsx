...
export default function HomeScreen() {
  ...
  const { breathStreak, journalStreak, refreshStreaks, streaksLoading } =
    useStreaks();
  ...
  const availableColors: FishColor[] = [
    "blue",
    "red",
    "green",
    "purple",
          ...
          <View style={[styles.card, { backgroundColor: cardColor }]}>
            ...
            <View style={styles.streakRow}>
              <Pressable
                ...
                style={[styles.streakItem, { backgroundColor: cardColor }]}
              >
                <View
                  style={[styles.streakItem, { backgroundColor: cardColor }]}
                >
                  <View
                    style={[styles.iconWrapper, { backgroundColor: cardColor }]}
                  >
                    <Icon
                      name="pencil"
                  ...
                  {isLoggedIn && (
                    <Text
                      testID="journal-streak"
                      style={styles.cardDataStreaks}
                    >
