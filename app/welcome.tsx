...
const slides = [
  ...
  },
  {
    key: "breathing",
    content:
      "Practice calming breathing exercises to relax your mind and body.",
    icon: (
      <Icon
        name="leaf-outline"
  ...
  },
  {
    key: "tracking",
    content:
      "Keep track of your mood, meditation minutes, daily streaks, and journaling habits.",
    icon: (
      <Icon
        name="line-chart"
...
export default function OnboardingScreen() {
  ...
  return (
    <ImageBackground source={WAVE} style={styles.background} resizeMode="cover">
